...
def plot_test_on_train(goal_values, test_scores, num_moves, max_num_moves):
  ...
  axs[0].set_xticks(range(0, NUM_EPOCHS + 1, 10))
  ...
  plt.tight_layout()
  plt.savefig('LSTM_DQN_100epochs.png')
  plt.show()
...
# with open('lstm_dqn_100epochs_data.pkl', 'wb') as f:
#   pickle.dump(save_data, f)

save_data = None
with open('lstm_dqn_100epochs_data.pkl', 'rb') as f:
  save_data = pickle.load(f)

all_goal_values = save_data['all_goal_values']
all_test_scores = save_data['all_test_scores']
all_num_moves = save_data['all_num_moves']
