...
def plot_test_on_train(goal_values, test_scores, num_moves, max_num_moves):
  ...
  axs[0].set_title('Magnitude of Value for TAKE COIN cmd [Level 5]')
  ...
  axs[1].set_title('# Score for 1 Play of Test Games [Level 5]')
  ...
  axs[2].set_title('# Moves for 1 Play of Test Games [Level 5]')
...
with open('lstm_dqn_data_lvl5.pkl', 'wb') as f:
